...
function cabinets4() {
    ...
    divElementCodCabinets4.style.display = "flex";
...
function cabinets5() {
    ...
    divElementCodCabinets5.style.display = "flex";
...
function cabinets6() {
    ...
    divElementCodCabinets6.style.display = "flex";
...
function cabinets7() {
    ...
    divElementCodCabinets7.style.display = "flex";
